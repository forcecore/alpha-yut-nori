...
class TestBoardPositions:
    ...
    def test_total_29_unique_positions(self):
        ...
        all_positions = set(Board.OUTER_POSITIONS + Board.RIGHT_DIAGONAL + Board.LEFT_DIAGONAL)
...
class TestBackwardMovement:
    ...
    def test_backward_from_00_invalid(self):
        board = Board()
        assert board.get_next_position('00', -1) is None
